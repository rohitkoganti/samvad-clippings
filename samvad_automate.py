...
def main():
    ...
    try:
        if browser:
            ...
            print('Login: Failed to start browser or failed to log-in into Samvad. Looping back.')
    except:
        print('Main: Something failed, quitting browser to be safe')
        browser.quit()
